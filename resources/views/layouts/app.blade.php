...
<head>
    ...
    <title>@yield('title', 'ARAP POS | Sistem Manajemen Kasir')</title>
    <style>
...
<body>
    ...
    <aside class="sidebar" id="mainSidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="{{ route('transactions.index') }}" class="sidebar-item {{ request()->routeIs('transactions.*') ? 'active' : '' }}">
        ...
        <div class="sidebar-footer">
            <div class="user-profile">
                ...
                <div style="overflow: hidden;">
                    <div style="font-weight: 700; font-size: 14px; white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">{{ auth()->user()->name }}</div>
    ...
    <!-- Main Content Area -->
    <main class="main-wrapper @guest guest-layout @endguest">
