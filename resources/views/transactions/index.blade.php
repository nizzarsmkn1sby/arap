...
@section('title', 'Riwayat Transaksi | ARAP POS')
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid var(--border); transition: var(--transition);">
                    ...
                    <td style="padding: 20px;">
                        <div style="font-weight: 700; color: #fff; font-size: 15px; margin-bottom: 4px;">{{ \Carbon\Carbon::parse($trx->transaction_date)->format('d M Y') }}</div>
                    ...
                    <td style="padding: 20px;">
                        <div style="display: flex; align-items: center; gap: 10px;">
                            ...
                            <span style="font-size: 14px; font-weight: 600; color: #fff;">{{ $trx->user->name ?? 'Tidak Diketahui' }}</span>
                        </div>
                    </td>
                    ...
                    <td>
                        <a href="{{ route('transactions.print', $trx->id) }}" target="_blank">
                           <button style="padding:5px 10px;">Print</button>
                        </a>
                    </td>
                </tr>
                @empty
