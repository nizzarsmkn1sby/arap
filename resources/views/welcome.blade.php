...
@section('title', 'ARAP POS | Solusi Kasir Profesional')
...
<div style="min-height: 90vh; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; padding: 40px;">
    ...
    <div style="display: flex; gap: 20px; flex-wrap: wrap; justify-content: center;">
        @auth
            <a href="{{ route('dashboard') }}" class="btn btn-primary" style="padding: 20px 50px; font-size: 16px;">
                Buka Panel Kontrol ⚡
            </a>
        @else
            <a href="{{ route('login') }}" class="btn btn-primary" style="padding: 20px 50px; font-size: 16px;">
                Masuk ke Sistem 🚀
            </a>
